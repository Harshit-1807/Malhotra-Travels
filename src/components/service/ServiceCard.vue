<template>
    ...
    <div class="service-card__actions">
      ...
      >
      <span>{{ ctaText }}</span>
      <svg xmlns="http://www.w3.org/2000/svg" class="service-card__cta-arrow" viewBox="0 0 20 20" fill="currentColor">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="service-card__whatsapp-icon">
  ...
  padding: 2.5rem 2rem;
  border-radius: 1rem;
  box-shadow: 0 10px 30px -3px rgba(0, 0, 0, 0.05), 0 4px 6px -2px rgba(0, 0, 0, 0.02);
    text-align: center;
...
.service-card__cta:focus {
  outline: none;
  box-shadow: 0 0 0 3px rgba(37, 99, 235, 0.5), 0 6px 20px -4px rgba(37, 99, 235, 0.4);
}
...
.service-card__whatsapp-btn:focus {
  outline: none;
  box-shadow: 0 0 0 3px rgba(37, 211, 102, 0.5), 0 6px 20px -4px rgba(37, 211, 102, 0.4);
}
